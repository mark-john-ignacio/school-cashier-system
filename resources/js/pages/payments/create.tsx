            ...
            <div className="flex flex-col gap-6">
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Search a student and capture their payment in under 30 seconds.</p>
                    </div>
                                    ...
                                    {students.map((studentOption) => (
                                        ...
                                        >
                                            ...
                                            <div className="mt-2 flex items-center justify-between text-xs text-muted-foreground">
                                                ...
                                                <span>Balance: ₱{studentOption.balance.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                                            </div>
                                        </button>
                                    ))}
                                </div>
                    ...
                    <form onSubmit={submit} className="grid gap-6 lg:col-span-3">
                        <div className="grid gap-6 rounded-xl border border-border/60 bg-card p-6 shadow-sm">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Enter the payment information exactly as reflected on the receipt.</p>
                            </div>
